...
# 4 SOLVED! Error when CREATE ANOTHER PASSWORD.  I have to delete Scrolledtext content, and the insert a new one
...
def generate_password():
	scr_pass.delete(1.0,"end") # Deletes previous content of the txt widget!
